    ...
    <>
      ...
      <div className="min-h-screen dark:bg-gray-950 bg-white text-gray-800 dark:text-white flex flex-col items-center">
        <div className="w-full max-w-7xl px-6 py-12 space-y-16">
          ...
          >
            ...
            >
              <div className="w-full md:w-1/2">
                ...
                <p className="text-lg">
                  At IndieConnect, our mission is to create a thriving ecosystem
            ...
            >
              <div className="w-full md:w-1/2">
                ...
                <p className="text-lg">
                  ...
                  everyone. By leveraging the power of technology, IndieConnect is
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="rounded-2xl shadow-md">
                <CardContent className="p-6 space-y-3">
                  ...
                  <p>
                    With chat, notifications, and live updates, IndieConnect keeps
          ...
          >
            <h2 className="text-2xl font-bold">Join the IndieConnect Revolution</h2>
            <p>
              Whether you're a freelancer looking for exciting projects or a
              client in search of talent, IndieConnect is your home.
            </p>
            <Button
              onClick={() => navigate("/")}
              size="lg"
